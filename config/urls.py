...
student_patterns = ([
    ...
    path('submissions/<uuid:submission_id>/file/', assignment_views.student_submission_file, name='submission_file'),
...
teacher_patterns = ([
    ...
    path('submissions/<uuid:submission_id>/file/', assignment_views.teacher_submission_file, name='submission_file'),
